...
selectClause : SELECT WS (COUNT | ((field COMMA WS?)* FIELDS WS? ( COMMA WS? field)*) | (field WS? ( COMMA WS? field)*))? ;
...
END : E N D ;
USING : U S I N G ;
FIELDS : F I E L D S WS? '(ALL)' | F I E L D S WS? '(STANDARD)' | F I E L D S WS? '(CUSTOM)';
